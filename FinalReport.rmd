...
According to this graph, black oppose capital punishment than they favor while the white and other races favor capital punishment more. 
...
The table reaffirms 68% of the white group are in favor, 46% of black and 56% of other are also in favor of capital punishment. 
...
```
Because we used more data, the Fisher XY test was able to show us that the different test groups are different from each other. Black and other, white and other and blacks and the whites are all different. 
