...
This data illustrates that the black group has an equal percentage of opposing capital punishment while the white and others have a 2:1 ratio in favor of capital punishment.   
...
The table reaffirms what was shown in the previous graph, that the black group had an equal percentage for in favor and opposing (49% vs 50%).  It also shows that in the White and other group were again a 2:1 ratio in favor.   
...
The Fisher XY test shows that the black and the other groups are indeed different.  It also provide the data that white and black groups are different. It does not show any more differences between the other and white groups.     